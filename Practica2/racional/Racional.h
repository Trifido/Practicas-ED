...
/**
  ...
  * @pre \b d debe ser distinto de cero
  */   
...
/**
  ...
  * @return Devuelve \c 0 si este objeto es igual a \b r, 
  *                  \c <0 si este objeto es menor que \b r, 
  *                  \c >0 si este objeto es mayor que \b r 
  */   
...
/**
  ...
  * @post Se obtiene en \a os la cadena (num/den) con \e num,\e den los valores
...
/**
  * @brief Convierte un racional en irreducible. Ej. 12/4 -> 3/1
  */
  Racional  simplifica();
...
/* Por ejemplo:
   ...
   Operadores de resta, multiplicación y división; inverso; 
   constructor a partir de un número decimal finito o periódico; etc.  
*/
