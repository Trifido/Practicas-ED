...
int main(int argc, char * argv[]){
  ...
  Imagen I;
			cout <<"ola k ase Imagen I" << endl;
  I.LeerImagen(argv[1]);
  double angulo=atof(argv[2]);
			cout <<"ola k ase Imagen atof" << endl;
  angulo = angulo*(M_PI)/180; //Pasamos el angulo radianes
			cout <<"ola k ase Imagen anguloradianes" << endl;
  Imagen Iout=Rota(I,angulo);
			cout <<"ola k ase Imagen ROTA" << endl;
  Iout.EscribirImagen(argv[3]);
  			cout <<"ola k ase EscribirImagen" << endl;
}  
